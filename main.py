...
from package_controllers.rpiController import RpiController
...
controller_rpi = RpiController(config.get_program_settings())
...
#controller_array.append(controller_rpi)
